 ...
 */
@Stateless
public class QualificadorAplicacaoFacade extends AbstractFacade<QualificadorAplicacao> {
    ...
    public QualificadorAplicacaoFacade() {
        super(QualificadorAplicacao.class);
    }
