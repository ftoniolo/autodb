 ...
 */
@Stateless
public class VeiculoBaseRelacionadoFacade extends AbstractFacade<VeiculoBaseRelacionado> {
    ...
    public VeiculoBaseRelacionadoFacade() {
        super(VeiculoBaseRelacionado.class);
    }
